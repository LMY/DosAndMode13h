...
unsigned long int read(int Handle, unsigned char String[], unsigned int N);	//read file, load into array
...
unsigned long int read(int Handle, unsigned char String[], unsigned int N)
{
